...
REM separate profile (C:\selenium_profile). Log in to the 5 sites ONCE here; it persists.
...
echo Log in to Marquee / BofA / HSBC / JPMM / UBS Neo once, keep Chrome open, then run:
